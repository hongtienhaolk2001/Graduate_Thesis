...
def main():
    data = pd.read_csv('../data_crawl/data_vungtau_ggmap.csv')

    # Add name column Review
    data.columns =['Review']
    ...
    with open(f"../data_preprocess/data_preprocess_vungtau.csv", "a", encoding='utf-8', newline='') as file:
        # Create a CSV writer
