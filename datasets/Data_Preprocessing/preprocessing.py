...
def clean_text(text):
    return {"Review": normalize_annotatation(
        remove_number(remove_special_char(remove_punctuation(strip_emoji(text["Review"].lower())))))}
...
class Preprocess():
    def __init__(self, tokenizer, rdrsegmenter):
        ...
        self.feature = ['lua_gao', 'ca_phe', 'cao_su'] #['giai_tri', 'luu_tru', 'nha_hang', 'an_uong', 'di_chuyen', 'mua_sam']
    ...
    def run(self, dataset):
        ...
        dataset = dataset.remove_columns(
            ['Unnamed: 0', 'Review', 'giai_tri', 'luu_tru', 'nha_hang', 'an_uong', 'di_chuyen', 'mua_sam', 'Segment'])
